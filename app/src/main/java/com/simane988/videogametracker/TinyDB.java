...
public class TinyDB {
    ...
    public ArrayList<VideoGame> getGamesList(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<VideoGame> game_list = new ArrayList<VideoGame>();

        for (String jObjString : objStrings) {
            VideoGame player = gson.fromJson(jObjString, VideoGame.class);
            game_list.add(player);
        }
        return game_list;
    }
    ...
    public void putGamesList(String key, ArrayList<VideoGame> gameList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (VideoGame vg : gameList) {
            objStrings.add(gson.toJson(vg));
        }
        putListString(key, objStrings);
    }
